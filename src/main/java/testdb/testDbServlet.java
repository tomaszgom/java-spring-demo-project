...
/************************************************
 * Class for db testing purposes Servlet implementation class testDbServlet
 ************************************************/
...
public class testDbServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			/*
			 * NOTE "jdbc:oracle:thin:@localhost:1521:xe","Admin","Password" Connection
			 * URL:"jdbc:oracle:thin:@localhost:1521:xe" API:jdbc Database: oracle The type
			 * of driver:thin IP Address:@localhost Port:1521 Oracle service ID: xe
			 * (enterprise eddition)
			 */
