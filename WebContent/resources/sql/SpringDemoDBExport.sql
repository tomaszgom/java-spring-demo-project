...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "HR"."CLIENT_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 53 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "HR"."P_ORDER_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 76 NOCACHE  NOORDER  NOCYCLE ;
REM INSERTING into HR.CLIENT
SET DEFINE OFF;
Insert into HR.CLIENT (CLIENT_ID,FIRST_NAME,LAST_NAME,CITY,POINTS,LAST_LOGIN_DATE) values (1,'James','Gosling','Calgary',56,to_date('15-APR-17','DD-MON-RR'));
Insert into HR.CLIENT (CLIENT_ID,FIRST_NAME,LAST_NAME,CITY,POINTS,LAST_LOGIN_DATE) values (2,'Tim','Berners-Lee','London',6,to_date('05-SEP-17','DD-MON-RR'));
Insert into HR.CLIENT (CLIENT_ID,FIRST_NAME,LAST_NAME,CITY,POINTS,LAST_LOGIN_DATE) values (3,'Chris','Fast','Warszawa',0,to_date('05-OCT-17','DD-MON-RR'));
...
Insert into HR.CLIENT (CLIENT_ID,FIRST_NAME,LAST_NAME,CITY,POINTS,LAST_LOGIN_DATE) values (5,'Bruce','Willis','New York',121,to_date('08-JUL-17','DD-MON-RR'));
...
Insert into HR.CLIENT (CLIENT_ID,FIRST_NAME,LAST_NAME,CITY,POINTS,LAST_LOGIN_DATE) values (8,'Benjamin','Franklin','Boston',0,to_date('14-SEP-80','DD-MON-RR'));
Insert into HR.CLIENT (CLIENT_ID,FIRST_NAME,LAST_NAME,CITY,POINTS,LAST_LOGIN_DATE) values (9,'Ellen','Doe','Warszawa',88,to_date('29-NOV-17','DD-MON-RR'));
Insert into HR.CLIENT (CLIENT_ID,FIRST_NAME,LAST_NAME,CITY,POINTS,LAST_LOGIN_DATE) values (10,'Ada','Lovelace','Warszawa',40,to_date('01-MAY-18','DD-MON-RR'));
Insert into HR.CLIENT (CLIENT_ID,FIRST_NAME,LAST_NAME,CITY,POINTS,LAST_LOGIN_DATE) values (36,'Victor','Ortiz','Los Angeles',111,to_date('08-DEC-17','DD-MON-RR'));
Insert into HR.CLIENT (CLIENT_ID,FIRST_NAME,LAST_NAME,CITY,POINTS,LAST_LOGIN_DATE) values (48,'Tyson','Fury','Manchester',8,to_date('23-MAR-18','DD-MON-RR'));
...
Insert into HR.CLIENT (CLIENT_ID,FIRST_NAME,LAST_NAME,CITY,POINTS,LAST_LOGIN_DATE) values (39,'Mike','Tyson','Las Vegas',null,to_date('01-MAY-18','DD-MON-RR'));
Insert into HR.CLIENT (CLIENT_ID,FIRST_NAME,LAST_NAME,CITY,POINTS,LAST_LOGIN_DATE) values (40,'Etienne','Robinson','New York',5,to_date('07-MAY-11','DD-MON-RR'));
Insert into HR.CLIENT (CLIENT_ID,FIRST_NAME,LAST_NAME,CITY,POINTS,LAST_LOGIN_DATE) values (42,'Jim','Beam','New York',null,to_date('01-MAY-18','DD-MON-RR'));
Insert into HR.CLIENT (CLIENT_ID,FIRST_NAME,LAST_NAME,CITY,POINTS,LAST_LOGIN_DATE) values (50,'Joshua','Parker','Auckland',54,to_date('15-JAN-18','DD-MON-RR'));
Insert into HR.CLIENT (CLIENT_ID,FIRST_NAME,LAST_NAME,CITY,POINTS,LAST_LOGIN_DATE) values (52,'Jack','Daniel','Lynchburg',null,null);
...
REM INSERTING into HR.P_ORDER
SET DEFINE OFF;
Insert into HR.P_ORDER (ORDER_ID,CLIENT_ID,ORDER_VALUE,PRODUCT_NAME,ORDER_DATE) values (59,7,1000,'Product 44',null);
Insert into HR.P_ORDER (ORDER_ID,CLIENT_ID,ORDER_VALUE,PRODUCT_NAME,ORDER_DATE) values (60,39,480,'Product 90',null);
Insert into HR.P_ORDER (ORDER_ID,CLIENT_ID,ORDER_VALUE,PRODUCT_NAME,ORDER_DATE) values (61,39,480,'Product 90',null);
Insert into HR.P_ORDER (ORDER_ID,CLIENT_ID,ORDER_VALUE,PRODUCT_NAME,ORDER_DATE) values (62,39,480,'Product 90',null);
Insert into HR.P_ORDER (ORDER_ID,CLIENT_ID,ORDER_VALUE,PRODUCT_NAME,ORDER_DATE) values (63,39,480,'Product 90',null);
Insert into HR.P_ORDER (ORDER_ID,CLIENT_ID,ORDER_VALUE,PRODUCT_NAME,ORDER_DATE) values (64,39,480,'Product 90',null);
Insert into HR.P_ORDER (ORDER_ID,CLIENT_ID,ORDER_VALUE,PRODUCT_NAME,ORDER_DATE) values (66,36,70,'Product 50',to_date('26-SEP-17','DD-MON-RR'));
Insert into HR.P_ORDER (ORDER_ID,CLIENT_ID,ORDER_VALUE,PRODUCT_NAME,ORDER_DATE) values (67,52,60,'Product 12',to_date('10-AUG-18','DD-MON-RR'));
Insert into HR.P_ORDER (ORDER_ID,CLIENT_ID,ORDER_VALUE,PRODUCT_NAME,ORDER_DATE) values (69,8,300,'Glasses',to_date('10-JUL-18','DD-MON-RR'));
Insert into HR.P_ORDER (ORDER_ID,CLIENT_ID,ORDER_VALUE,PRODUCT_NAME,ORDER_DATE) values (71,1,300,'Cigars',to_date('12-JUN-18','DD-MON-RR'));
Insert into HR.P_ORDER (ORDER_ID,CLIENT_ID,ORDER_VALUE,PRODUCT_NAME,ORDER_DATE) values (75,11,380,'Product 007',to_date('03-MAY-18','DD-MON-RR'));
Insert into HR.P_ORDER (ORDER_ID,CLIENT_ID,ORDER_VALUE,PRODUCT_NAME,ORDER_DATE) values (29,11,150,'Product 225',to_date('10-FEB-18','DD-MON-RR'));
Insert into HR.P_ORDER (ORDER_ID,CLIENT_ID,ORDER_VALUE,PRODUCT_NAME,ORDER_DATE) values (30,1,100,'Product 10',to_date('01-DEC-17','DD-MON-RR'));
Insert into HR.P_ORDER (ORDER_ID,CLIENT_ID,ORDER_VALUE,PRODUCT_NAME,ORDER_DATE) values (31,1,100,'Product 20',to_date('01-DEC-17','DD-MON-RR'));
Insert into HR.P_ORDER (ORDER_ID,CLIENT_ID,ORDER_VALUE,PRODUCT_NAME,ORDER_DATE) values (32,2,120,'Product 10',to_date('31-DEC-17','DD-MON-RR'));
Insert into HR.P_ORDER (ORDER_ID,CLIENT_ID,ORDER_VALUE,PRODUCT_NAME,ORDER_DATE) values (33,2,120,'Product 20',to_date('31-DEC-17','DD-MON-RR'));
Insert into HR.P_ORDER (ORDER_ID,CLIENT_ID,ORDER_VALUE,PRODUCT_NAME,ORDER_DATE) values (34,2,120,'Product 30',to_date('31-DEC-17','DD-MON-RR'));
Insert into HR.P_ORDER (ORDER_ID,CLIENT_ID,ORDER_VALUE,PRODUCT_NAME,ORDER_DATE) values (35,3,140,'Product 30',to_date('10-OCT-17','DD-MON-RR'));
Insert into HR.P_ORDER (ORDER_ID,CLIENT_ID,ORDER_VALUE,PRODUCT_NAME,ORDER_DATE) values (36,4,160,'Product 10',to_date('10-OCT-17','DD-MON-RR'));
Insert into HR.P_ORDER (ORDER_ID,CLIENT_ID,ORDER_VALUE,PRODUCT_NAME,ORDER_DATE) values (37,5,180,'Product 30',to_date('20-MAR-17','DD-MON-RR'));
Insert into HR.P_ORDER (ORDER_ID,CLIENT_ID,ORDER_VALUE,PRODUCT_NAME,ORDER_DATE) values (38,5,180,'Product 20',to_date('20-MAR-17','DD-MON-RR'));
Insert into HR.P_ORDER (ORDER_ID,CLIENT_ID,ORDER_VALUE,PRODUCT_NAME,ORDER_DATE) values (39,6,200,'Product 10',to_date('20-MAR-17','DD-MON-RR'));
Insert into HR.P_ORDER (ORDER_ID,CLIENT_ID,ORDER_VALUE,PRODUCT_NAME,ORDER_DATE) values (40,7,220,'Product 20',to_date('26-SEP-17','DD-MON-RR'));
Insert into HR.P_ORDER (ORDER_ID,CLIENT_ID,ORDER_VALUE,PRODUCT_NAME,ORDER_DATE) values (41,7,220,'Product 10',to_date('26-SEP-17','DD-MON-RR'));
Insert into HR.P_ORDER (ORDER_ID,CLIENT_ID,ORDER_VALUE,PRODUCT_NAME,ORDER_DATE) values (42,8,100,'Product 10',to_date('01-DEC-17','DD-MON-RR'));
Insert into HR.P_ORDER (ORDER_ID,CLIENT_ID,ORDER_VALUE,PRODUCT_NAME,ORDER_DATE) values (43,9,120,'Product 20',to_date('20-MAR-17','DD-MON-RR'));
Insert into HR.P_ORDER (ORDER_ID,CLIENT_ID,ORDER_VALUE,PRODUCT_NAME,ORDER_DATE) values (44,10,140,'Product 10',to_date('01-MAY-18','DD-MON-RR'));
Insert into HR.P_ORDER (ORDER_ID,CLIENT_ID,ORDER_VALUE,PRODUCT_NAME,ORDER_DATE) values (45,10,140,'Product 30',to_date('01-MAY-18','DD-MON-RR'));
Insert into HR.P_ORDER (ORDER_ID,CLIENT_ID,ORDER_VALUE,PRODUCT_NAME,ORDER_DATE) values (46,11,160,'Product 20',to_date('01-JAN-00','DD-MON-RR'));
Insert into HR.P_ORDER (ORDER_ID,CLIENT_ID,ORDER_VALUE,PRODUCT_NAME,ORDER_DATE) values (47,12,55,'Product 10',to_date('01-DEC-17','DD-MON-RR'));
Insert into HR.P_ORDER (ORDER_ID,CLIENT_ID,ORDER_VALUE,PRODUCT_NAME,ORDER_DATE) values (48,13,60,'Product 30',to_date('08-DEC-17','DD-MON-RR'));
Insert into HR.P_ORDER (ORDER_ID,CLIENT_ID,ORDER_VALUE,PRODUCT_NAME,ORDER_DATE) values (49,32,70,'Product 20',to_date('15-JAN-18','DD-MON-RR'));
Insert into HR.P_ORDER (ORDER_ID,CLIENT_ID,ORDER_VALUE,PRODUCT_NAME,ORDER_DATE) values (50,36,80,'Product 10',to_date('20-MAR-17','DD-MON-RR'));
Insert into HR.P_ORDER (ORDER_ID,CLIENT_ID,ORDER_VALUE,PRODUCT_NAME,ORDER_DATE) values (51,36,80,'Product 20',to_date('20-MAR-17','DD-MON-RR'));
Insert into HR.P_ORDER (ORDER_ID,CLIENT_ID,ORDER_VALUE,PRODUCT_NAME,ORDER_DATE) values (52,39,90,'Product 20',to_date('01-MAY-18','DD-MON-RR'));
Insert into HR.P_ORDER (ORDER_ID,CLIENT_ID,ORDER_VALUE,PRODUCT_NAME,ORDER_DATE) values (53,40,100,'Product 10',to_date('20-MAR-17','DD-MON-RR'));
Insert into HR.P_ORDER (ORDER_ID,CLIENT_ID,ORDER_VALUE,PRODUCT_NAME,ORDER_DATE) values (54,42,110,'Product 30',to_date('01-MAY-18','DD-MON-RR'));
Insert into HR.P_ORDER (ORDER_ID,CLIENT_ID,ORDER_VALUE,PRODUCT_NAME,ORDER_DATE) values (55,48,120,'Product 20',to_date('22-MAR-18','DD-MON-RR'));
Insert into HR.P_ORDER (ORDER_ID,CLIENT_ID,ORDER_VALUE,PRODUCT_NAME,ORDER_DATE) values (56,50,130,'Product 10',to_date('15-JAN-18','DD-MON-RR'));
Insert into HR.P_ORDER (ORDER_ID,CLIENT_ID,ORDER_VALUE,PRODUCT_NAME,ORDER_DATE) values (57,12,190,'Product 30',to_date('26-SEP-17','DD-MON-RR'));
Insert into HR.P_ORDER (ORDER_ID,CLIENT_ID,ORDER_VALUE,PRODUCT_NAME,ORDER_DATE) values (73,1,10,'Cuba Libre',to_date('11-NOV-17','DD-MON-RR'));
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  TABLESPACE "USERS" ;
--------------------------------------------------------
--  DDL for Index P_ORDER_PK
--------------------------------------------------------

  CREATE UNIQUE INDEX "HR"."P_ORDER_PK" ON "HR"."P_ORDER" ("ORDER_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS" ;
...
--------------------------------------------------------
--  DDL for Trigger P_ORDER_INS_ID
--------------------------------------------------------

  CREATE OR REPLACE TRIGGER "HR"."P_ORDER_INS_ID" 
  BEFORE INSERT ON p_order
  FOR EACH ROW
BEGIN
...
END;
/
ALTER TRIGGER "HR"."P_ORDER_INS_ID" ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "HR"."P_ORDER" ADD CONSTRAINT "P_ORDER_PK" PRIMARY KEY ("ORDER_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS"  ENABLE;
  ALTER TABLE "HR"."P_ORDER" MODIFY ("CLIENT_ID" NOT NULL ENABLE);
  ALTER TABLE "HR"."P_ORDER" MODIFY ("ORDER_ID" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "HR"."EMPLOYEES" ADD CONSTRAINT "EMP_MANAGER_FK" FOREIGN KEY ("MANAGER_ID")
	  REFERENCES "HR"."EMPLOYEES" ("EMPLOYEE_ID") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table P_ORDER
--------------------------------------------------------

  ALTER TABLE "HR"."P_ORDER" ADD CONSTRAINT "CLIENT_FK" FOREIGN KEY ("CLIENT_ID")
	  REFERENCES "HR"."CLIENT" ("CLIENT_ID") ENABLE;
