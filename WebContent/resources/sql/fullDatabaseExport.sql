...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "HR"."CLIENT_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 38 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
...
Insert into HR.CLIENT (CLIENT_ID,FIRST_NAME,LAST_NAME,CITY,POINTS,LAST_LOGIN_DATE) values (3,'Chris','Fast','Warszawa',40,to_date('01-MAY-18','DD-MON-RR'));
...
Insert into HR.CLIENT (CLIENT_ID,FIRST_NAME,LAST_NAME,CITY,POINTS,LAST_LOGIN_DATE) values (5,null,'Mexico','New York',101,to_date('31-DEC-17','DD-MON-RR'));
